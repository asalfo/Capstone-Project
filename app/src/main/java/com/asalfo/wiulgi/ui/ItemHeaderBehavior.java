...
public class ItemHeaderBehavior extends CoordinatorLayout.Behavior<ItemHeaderView> {
    ...
    public ItemHeaderBehavior() {
    }

    public ItemHeaderBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }
    ...
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, ItemHeaderView child, View dependency) {
