...
public class WiugliRecyclerView extends RecyclerView {
    ...
    public WiugliRecyclerView(Context context) {
        super(context);
    }

    public WiugliRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public WiugliRecyclerView(Context context, AttributeSet attrs, int defStyle) {
